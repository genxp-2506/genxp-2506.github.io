...
But, we can also use the p5.js [`map()`](https://p5js.org/reference/p5/map) function to do this math for us and keep our code easier to read and maintain (a detailed explanation of `map()` can be found [here](../../week03/maths/)).
